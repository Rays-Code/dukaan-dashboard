...
const Navbar = () => {
  return (
    <div className='flex bg-white sm:justify-between justify-between gap-3 border-b border-gray-300 sm:w-full w-160 h-16'>
        <div className='flex'>
            ...
            <div className='flex pt-5 ml-4'>
                ...
                <p className='ml-2'>How it works</p>
            </div>          
            </div>

        <div><SearchBar /></div>

        <div className='flex gap-1 sm:mr-6 mr-2  h-10 mt-3 '>
